...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new invoicetronicSdk.CessionarioCommittente();
  });
  ...
  describe('CessionarioCommittente', function() {
    it('should create an instance of CessionarioCommittente', function() {
      ...
      //var instance = new invoicetronicSdk.CessionarioCommittente();
      //expect(instance).to.be.a(invoicetronicSdk.CessionarioCommittente);
    });
