...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new invoicetronic-invoice-sdk.DatiOrdineAcquisto();
  });
  ...
  describe('DatiOrdineAcquisto', function() {
    it('should create an instance of DatiOrdineAcquisto', function() {
      ...
      //var instance = new invoicetronic-invoice-sdk.DatiOrdineAcquisto();
      //expect(instance).to.be.a(invoicetronic-invoice-sdk.DatiOrdineAcquisto);
    });
