...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new invoicetronicSdk.DatiCassaPrevidenziale();
  });
  ...
  describe('DatiCassaPrevidenziale', function() {
    it('should create an instance of DatiCassaPrevidenziale', function() {
      ...
      //var instance = new invoicetronicSdk.DatiCassaPrevidenziale();
      //expect(instance).to.be.a(invoicetronicSdk.DatiCassaPrevidenziale);
    });
