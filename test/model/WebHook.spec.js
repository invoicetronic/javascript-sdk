...
(function(root, factory) {
  ...
  describe('WebHook', function() {
    ...
    it('should have the property failureNotifiedAt (base name: "failure_notified_at")', function() {
      // uncomment below and update the code to test the property failureNotifiedAt
      //var instance = new invoicetronicSdk.WebHook();
      //expect(instance).to.be();
    });
