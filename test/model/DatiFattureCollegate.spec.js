...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new invoicetronic-invoice-sdk.DatiFattureCollegate();
  });
  ...
  describe('DatiFattureCollegate', function() {
    it('should create an instance of DatiFattureCollegate', function() {
      ...
      //var instance = new invoicetronic-invoice-sdk.DatiFattureCollegate();
      //expect(instance).to.be.a(invoicetronic-invoice-sdk.DatiFattureCollegate);
    });
