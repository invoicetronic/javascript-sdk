...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new invoicetronicSdk.DatiFattureCollegate();
  });
  ...
  describe('DatiFattureCollegate', function() {
    it('should create an instance of DatiFattureCollegate', function() {
      ...
      //var instance = new invoicetronicSdk.DatiFattureCollegate();
      //expect(instance).to.be.a(invoicetronicSdk.DatiFattureCollegate);
    });
