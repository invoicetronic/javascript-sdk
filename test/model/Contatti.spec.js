...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new invoicetronic-invoice-sdk.Contatti();
  });
  ...
  describe('Contatti', function() {
    it('should create an instance of Contatti', function() {
      // uncomment below and update the code to test Contatti
      //var instance = new invoicetronic-invoice-sdk.Contatti();
      //expect(instance).to.be.a(invoicetronic-invoice-sdk.Contatti);
    });
