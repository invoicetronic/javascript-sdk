...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new invoicetronicSdk.FatturaOrdinaria();
  });
  ...
  describe('FatturaOrdinaria', function() {
    it('should create an instance of FatturaOrdinaria', function() {
      ...
      //var instance = new invoicetronicSdk.FatturaOrdinaria();
      //expect(instance).to.be.a(invoicetronicSdk.FatturaOrdinaria);
    });
