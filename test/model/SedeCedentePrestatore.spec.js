...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new invoicetronicSdk.SedeCedentePrestatore();
  });
  ...
  describe('SedeCedentePrestatore', function() {
    it('should create an instance of SedeCedentePrestatore', function() {
      ...
      //var instance = new invoicetronicSdk.SedeCedentePrestatore();
      //expect(instance).to.be.a(invoicetronicSdk.SedeCedentePrestatore);
    });
