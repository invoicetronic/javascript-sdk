...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new invoicetronicSdk.RappresentanteFiscale();
  });
  ...
  describe('RappresentanteFiscale', function() {
    it('should create an instance of RappresentanteFiscale', function() {
      ...
      //var instance = new invoicetronicSdk.RappresentanteFiscale();
      //expect(instance).to.be.a(invoicetronicSdk.RappresentanteFiscale);
    });
