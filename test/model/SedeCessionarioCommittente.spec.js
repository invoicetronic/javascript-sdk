...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new invoicetronic-invoice-sdk.SedeCessionarioCommittente();
  });
  ...
  describe('SedeCessionarioCommittente', function() {
    it('should create an instance of SedeCessionarioCommittente', function() {
      ...
      //var instance = new invoicetronic-invoice-sdk.SedeCessionarioCommittente();
      //expect(instance).to.be.a(invoicetronic-invoice-sdk.SedeCessionarioCommittente);
    });
