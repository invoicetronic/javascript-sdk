...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new invoicetronicSdk.ContattiTrasmittente();
  });
  ...
  describe('ContattiTrasmittente', function() {
    it('should create an instance of ContattiTrasmittente', function() {
      ...
      //var instance = new invoicetronicSdk.ContattiTrasmittente();
      //expect(instance).to.be.a(invoicetronicSdk.ContattiTrasmittente);
    });
