...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new invoicetronicSdk.DatiAnagraficiCessionarioCommittente();
  });
  ...
  describe('DatiAnagraficiCessionarioCommittente', function() {
    it('should create an instance of DatiAnagraficiCessionarioCommittente', function() {
      ...
      //var instance = new invoicetronicSdk.DatiAnagraficiCessionarioCommittente();
      //expect(instance).to.be.a(invoicetronicSdk.DatiAnagraficiCessionarioCommittente);
    });
