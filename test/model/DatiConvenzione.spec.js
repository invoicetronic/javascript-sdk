...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new invoicetronic-invoice-sdk.DatiConvenzione();
  });
  ...
  describe('DatiConvenzione', function() {
    it('should create an instance of DatiConvenzione', function() {
      // uncomment below and update the code to test DatiConvenzione
      //var instance = new invoicetronic-invoice-sdk.DatiConvenzione();
      //expect(instance).to.be.a(invoicetronic-invoice-sdk.DatiConvenzione);
    });
