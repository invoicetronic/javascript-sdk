...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new invoicetronicSdk.AltriDatiGestionali();
  });
  ...
  describe('AltriDatiGestionali', function() {
    it('should create an instance of AltriDatiGestionali', function() {
      ...
      //var instance = new invoicetronicSdk.AltriDatiGestionali();
      //expect(instance).to.be.a(invoicetronicSdk.AltriDatiGestionali);
    });
