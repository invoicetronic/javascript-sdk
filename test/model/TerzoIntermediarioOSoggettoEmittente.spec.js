...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new invoicetronicSdk.TerzoIntermediarioOSoggettoEmittente();
  });
  ...
  describe('TerzoIntermediarioOSoggettoEmittente', function() {
    it('should create an instance of TerzoIntermediarioOSoggettoEmittente', function() {
      ...
      //var instance = new invoicetronicSdk.TerzoIntermediarioOSoggettoEmittente();
      //expect(instance).to.be.a(invoicetronicSdk.TerzoIntermediarioOSoggettoEmittente);
    });
