...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new invoicetronicSdk.FatturaPrincipale();
  });
  ...
  describe('FatturaPrincipale', function() {
    it('should create an instance of FatturaPrincipale', function() {
      ...
      //var instance = new invoicetronicSdk.FatturaPrincipale();
      //expect(instance).to.be.a(invoicetronicSdk.FatturaPrincipale);
    });
