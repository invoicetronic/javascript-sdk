...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new invoicetronic-invoice-sdk.Receive();
  });
  ...
  describe('Receive', function() {
    it('should create an instance of Receive', function() {
      ...
      //var instance = new invoicetronic-invoice-sdk.Receive();
      //expect(instance).to.be.a(invoicetronic-invoice-sdk.Receive);
    });
