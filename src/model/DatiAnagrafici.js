...
class DatiAnagrafici {
    /**
     * Constructs a new <code>DatiAnagrafici</code>.
     * @alias module:model/DatiAnagrafici
     */
    constructor() { 
        
        DatiAnagrafici.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DatiAnagrafici</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DatiAnagrafici} obj Optional instance to populate.
     * @return {module:model/DatiAnagrafici} The populated <code>DatiAnagrafici</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DatiAnagrafici();
    ...
    /**
     * Validates the JSON data with respect to <code>DatiAnagrafici</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DatiAnagrafici</code>.
     */
 ...
 */
DatiAnagrafici.prototype['id_fiscale_iva'] = undefined;

/**
 * @member {String} codice_fiscale
 */
DatiAnagrafici.prototype['codice_fiscale'] = undefined;

/**
 * @member {module:model/Anagrafica} anagrafica
 */
DatiAnagrafici.prototype['anagrafica'] = undefined;
