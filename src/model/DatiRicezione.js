...
class DatiRicezione {
    /**
     * Constructs a new <code>DatiRicezione</code>.
     * @alias module:model/DatiRicezione
     */
    constructor() { 
        
        DatiRicezione.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DatiRicezione</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DatiRicezione} obj Optional instance to populate.
     * @return {module:model/DatiRicezione} The populated <code>DatiRicezione</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DatiRicezione();
    ...
    /**
     * Validates the JSON data with respect to <code>DatiRicezione</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DatiRicezione</code>.
     */
 ...
 */
DatiRicezione.prototype['riferimento_numero_linea'] = undefined;

/**
 * @member {String} id_documento
 */
DatiRicezione.prototype['id_documento'] = undefined;

/**
 * @member {Date} data
 */
DatiRicezione.prototype['data'] = undefined;

/**
 * @member {String} num_item
 */
DatiRicezione.prototype['num_item'] = undefined;

/**
 * @member {String} codice_commessa_convenzione
 */
DatiRicezione.prototype['codice_commessa_convenzione'] = undefined;

/**
 * @member {String} codice_cup
 */
DatiRicezione.prototype['codice_cup'] = undefined;

/**
 * @member {String} codice_cig
 */
DatiRicezione.prototype['codice_cig'] = undefined;
