...
class DatiContratto {
    /**
     * Constructs a new <code>DatiContratto</code>.
     * @alias module:model/DatiContratto
     */
    constructor() { 
        
        DatiContratto.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DatiContratto</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DatiContratto} obj Optional instance to populate.
     * @return {module:model/DatiContratto} The populated <code>DatiContratto</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DatiContratto();
    ...
    /**
     * Validates the JSON data with respect to <code>DatiContratto</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DatiContratto</code>.
     */
 ...
 */
DatiContratto.prototype['riferimento_numero_linea'] = undefined;

/**
 * @member {String} id_documento
 */
DatiContratto.prototype['id_documento'] = undefined;

/**
 * @member {Date} data
 */
DatiContratto.prototype['data'] = undefined;

/**
 * @member {String} num_item
 */
DatiContratto.prototype['num_item'] = undefined;

/**
 * @member {String} codice_commessa_convenzione
 */
DatiContratto.prototype['codice_commessa_convenzione'] = undefined;

/**
 * @member {String} codice_cup
 */
DatiContratto.prototype['codice_cup'] = undefined;

/**
 * @member {String} codice_cig
 */
DatiContratto.prototype['codice_cig'] = undefined;
