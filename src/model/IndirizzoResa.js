...
class IndirizzoResa {
    /**
     * Constructs a new <code>IndirizzoResa</code>.
     * @alias module:model/IndirizzoResa
     */
    constructor() { 
        
        IndirizzoResa.initialize(this);
    }
    ...
    /**
     * Constructs a <code>IndirizzoResa</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IndirizzoResa} obj Optional instance to populate.
     * @return {module:model/IndirizzoResa} The populated <code>IndirizzoResa</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IndirizzoResa();
    ...
    /**
     * Validates the JSON data with respect to <code>IndirizzoResa</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IndirizzoResa</code>.
     */
 ...
 */
IndirizzoResa.prototype['indirizzo'] = undefined;

/**
 * @member {String} numero_civico
 */
IndirizzoResa.prototype['numero_civico'] = undefined;

/**
 * @member {String} cap
 */
IndirizzoResa.prototype['cap'] = undefined;

/**
 * @member {String} comune
 */
IndirizzoResa.prototype['comune'] = undefined;

/**
 * @member {String} provincia
 */
IndirizzoResa.prototype['provincia'] = undefined;

/**
 * @member {String} nazione
 * @default 'IT'
 */
IndirizzoResa.prototype['nazione'] = 'IT';
