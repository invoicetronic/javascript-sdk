...
class StabileOrganizzazione {
    /**
     * Constructs a new <code>StabileOrganizzazione</code>.
     * @alias module:model/StabileOrganizzazione
     */
    constructor() { 
        
        StabileOrganizzazione.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StabileOrganizzazione</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StabileOrganizzazione} obj Optional instance to populate.
     * @return {module:model/StabileOrganizzazione} The populated <code>StabileOrganizzazione</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StabileOrganizzazione();
    ...
    /**
     * Validates the JSON data with respect to <code>StabileOrganizzazione</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StabileOrganizzazione</code>.
     */
 ...
 */
StabileOrganizzazione.prototype['indirizzo'] = undefined;

/**
 * @member {String} numero_civico
 */
StabileOrganizzazione.prototype['numero_civico'] = undefined;

/**
 * @member {String} cap
 */
StabileOrganizzazione.prototype['cap'] = undefined;

/**
 * @member {String} comune
 */
StabileOrganizzazione.prototype['comune'] = undefined;

/**
 * @member {String} provincia
 */
StabileOrganizzazione.prototype['provincia'] = undefined;

/**
 * @member {String} nazione
 * @default 'IT'
 */
StabileOrganizzazione.prototype['nazione'] = 'IT';
...
export default StabileOrganizzazione;
